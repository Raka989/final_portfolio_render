                            ...
                            <div class="card">
                             ...
                             @foreach ($blog as $blogs )
                                    ...
                                    <tr style="border-style: solid;">
                                        ...
                                        <td><img src="{{asset('blog_images/' .$blogs->image)}}" style="height: 100px; object-fit: contain;"></td>

                                        <td>{{$blogs->title}}</td>
                                        <td style="max-width:50px;    white-space: nowrap; overflow: hidden;   text-overflow: ellipsis;">{{$blogs->short_description}} </td>
                                        <td style="max-width:50px;    white-space: nowrap; overflow: hidden;   text-overflow: ellipsis;">{{$blogs->long_description}}</td>
                                        <td>{{$blogs->date}}</td>
                                        <td> <a class="btn btn-danger" href="blog_delete{{$blogs->blog_id}}">delete</a></td>
                                        <td> <a class="btn btn-danger" href="{{URL::to('blog_edit'.($blogs->blog_id))}}"> edit</a></td>
