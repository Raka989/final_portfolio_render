                            ...
                            <div class="card">
                             ...
                             @foreach ( $slider as $sliders)
                                    ...
                                    <tr style="border-style: solid;">
                                        ...
                                        <td><img src="{{asset('slider_images/'.$sliders->image)}}" style="height: 100px; object-fit: contain;"></td>

                                        <td>{{$sliders->title}}</td>
                                       <td><a class="btn btn-danger" href='slider_delete{{($sliders->slider_id)}}' role="button">Delete</a></td>
                                       <td><a class="btn btn-primary" href="{{URL::to('slider_edit'.encrypt($sliders->slider_id))}}" role="button">Edit</a></td>
                                        @endforeach
                                    </tr>
                                    <tbody>
